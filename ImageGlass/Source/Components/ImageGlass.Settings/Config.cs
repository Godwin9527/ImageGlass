...
public static class Config
{
    ...
    /// <summary>
    /// Remember the main window size and position from the last session.
    /// </summary>
    public static bool EnableRememberWindowBounds { get; set; } = true;
...
#nullable disable
        ...
        EnableRememberWindowBounds = items.GetValueEx(nameof(EnableRememberWindowBounds), EnableRememberWindowBounds);
...
#nullable enable 
    ...
    public static ExpandoObject PrepareJsonSettingsObject(bool useAbsoluteFileUrl = false)
    {
        ...
        _ = settings.TryAdd(nameof(EnableRememberWindowBounds), EnableRememberWindowBounds);
